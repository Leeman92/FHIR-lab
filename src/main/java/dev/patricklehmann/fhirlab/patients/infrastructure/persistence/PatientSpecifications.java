...
public final class PatientSpecifications {
    ...
    public static Specification<Patient> givenNameSimilarTo(String givenName) {
        return wordSimilarTo("givenName", normalize(givenName), NAME_SIMILARITY_THRESHOLD);
    }

    public static Specification<Patient> familyNameSimilarTo(String familyName) {
        return wordSimilarTo("familyName", normalize(familyName), NAME_SIMILARITY_THRESHOLD);
    }
    ...
    private static Specification<Patient> wordSimilarTo(
            String nameAttribute, String searchTerm, double threshold) {
        return (root, query, builder) -> {
            ...
            return builder.greaterThanOrEqualTo(similarity, threshold);
        };
    }
